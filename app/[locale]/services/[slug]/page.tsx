        ...
        <div className="wrap grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,7fr)_minmax(0,5fr)]">
          ...
          <aside className="grid content-start gap-4">
            ...
            <div className="rounded-card border border-line bg-surface p-5 text-[0.95rem]">
              ...
              <p className="mt-3 mb-0 font-mono text-[0.8rem] text-muted">{site.phones.operations.label}: <a className="text-ink" href={`tel:${site.phones.operations.e164}`}>{site.phones.operations.display}</a></p>
            </div>
            <div className="rounded-card border border-line bg-surface p-5 text-[0.95rem]">
