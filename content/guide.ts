...
export const guide: Record<Locale, Guide> = {
  en: {
    ...
    tldr: [
      ...
      'Booking periods and fees are set by the Panama Canal Authority\'s OP Notice to Shipping in force (N-7-2026 at the time of writing). Booking fees are paid or guaranteed on the same terms as tolls.',
    ...
    sections: [
      ...
      {id: 'requirements', h2: '3. Requirements and documents', ul: [
        'ETA notification to the ACP at least 96 hours before arrival, with the vessel particulars, certificates, crew list and dangerous cargo declaration the Authority requires for the call.',
        'PCSOPEP: the Panama Canal Shipboard Oil Pollution Emergency Plan. The ACP classifies vessels in tiers by oil-carrying capacity and charges per transit accordingly, from USD 660 in tier 1 to USD 2,000 in tier 4 (Advisory A-58-2023). The plan has to be filed and valid before the call.',
        'Admeasurement and PC/UMS certificate for first-time transits; inspection on arrival.',
        'Funds: booking fees and tolls are paid or guaranteed before the transit. We call funds early enough to leave margin for bank delays.',
      ]},
      ...
      {id: 'mistakes', h2: '6. Common mistakes', ul: ['Nominating late and paying a last-minute reservation or an auction premium.', 'Estimating the toll with the wrong measurement basis (PC/UMS versus DWT versus TEU).', 'Arriving without a valid PCSOPEP on file.', 'Calling funds after the ACP deadline.', 'Planning a crew change without immigration lead time.']},
    ],
    faq: [
      ...
      {q: 'How long does a transit take?', a: 'The Canal measures it as In-Transit Time, and its NetZero slot is the one that carries a guaranteed 24 hours in transit. Everything else depends on booking, traffic and the vessel. We do not promise transit times.'},
      ...
      {q: 'When are funds due?', a: 'Booking fees are paid or guaranteed on the same terms as tolls, before the transit. We call funds early enough to absorb bank delays.'},
    ],
    sources: [
  ...
  es: {
    ...
    tldr: [
      ...
      'Los periodos de reserva y las tasas los fija el OP Notice to Shipping vigente de la Autoridad del Canal (N-7-2026 al momento de escribir). Las tasas de reserva se pagan o se garantizan en los mismos términos que los peajes.',
    ...
    sections: [
      ...
      {id: 'requirements', h2: '3. Requisitos y documentos', ul: [
        'Notificación de ETA a la ACP con al menos 96 horas de anticipación al arribo, con los datos del buque, certificados, lista de tripulación y declaración de carga peligrosa que exija la Autoridad para la escala.',
        'PCSOPEP: el plan de emergencia por contaminación por hidrocarburos del Canal. La ACP clasifica los buques en tiers según su capacidad de transporte de hidrocarburos y cobra por tránsito en consecuencia, de 660 dólares en el tier 1 a 2.000 en el tier 4 (aviso A-58-2023). El plan debe estar presentado y vigente antes de la escala.',
        'Arqueo y certificado PC/UMS para el primer tránsito; inspección al arribo.',
        'Fondos: las tasas de reserva y los peajes se pagan o se garantizan antes del tránsito. Llamamos los fondos con margen suficiente para absorber demoras bancarias.',
      ]},
      ...
      {id: 'mistakes', h2: '6. Errores comunes', ul: ['Nominar tarde y pagar una reserva de último momento o una prima de subasta.', 'Estimar el peaje con la base de medición equivocada (PC/UMS versus DWT versus TEU).', 'Llegar sin el PCSOPEP presentado y vigente.', 'Llamar los fondos después del plazo de la ACP.', 'Planificar un cambio de tripulación sin plazo de migración.']},
    ],
    faq: [
      ...
      {q: '¿Cuánto dura un tránsito?', a: 'El Canal lo mide como tiempo en tránsito, y el único cupo que trae 24 horas garantizadas es el NetZero. Lo demás depende de la reserva, del tráfico y del buque. No prometemos tiempos de tránsito.'},
      ...
      {q: '¿Cuándo se pagan los fondos?', a: 'Las tasas de reserva se pagan o se garantizan en los mismos términos que los peajes, antes del tránsito. Llamamos los fondos con margen para absorber demoras bancarias.'},
    ],
    sources: [
