...
export const pages: Record<'about' | 'certifications' | 'compliance' | 'contact' | 'privacy' | 'terms', Record<Locale, StaticPage>> = {
  about: {
    en: {
      ...
      blocks: [
        {h2: 'Timeline', ul: ['2010: AMP ship agency licence and Panama Canal Authority authorization (4 March 2010).', 'ISO 9001, 14001, 45001 and 22000 certifications, issued by AQC Middle East LLC.', 'SOS Resilience Holding, fuel marketing line.', 'Representation in Venezuela, Brazil, Aruba and Greece.']},
        {h2: 'The captain', p: ['Captain Guillermo A. Peña brings more than 40 years of maritime experience. He holds the ISM Code Internal Auditor credential (ABSG Consulting), trained at the Seafarers Training Center, the Maersk Training Centre and NFPA / Texas Engineering Extension Service, and reviews every survey report and every PDA that leaves this office.']},
        ...
        {h2: 'Ethics channel', p: ['Concerns about our conduct can be reported to the office by email or phone. Reports are handled by the managing director and, where needed, by external counsel.']},
      ],
    },
    es: {
      ...
      blocks: [
        {h2: 'Línea de tiempo', ul: ['2010: licencia AMP y autorización de la Autoridad del Canal (4 de marzo de 2010).', 'Certificaciones ISO 9001, 14001, 45001 y 22000, emitidas por AQC Middle East LLC.', 'SOS Resilience Holding, línea de comercialización de combustible.', 'Representación en Venezuela, Brasil, Aruba y Grecia.']},
        {h2: 'El capitán', p: ['El capitán Guillermo A. Peña suma más de 40 años de experiencia marítima. Es auditor interno del Código ISM (ABSG Consulting), formado en el Seafarers Training Center, el Maersk Training Centre y NFPA / Texas Engineering Extension Service, y revisa cada informe de inspección y cada PDA que sale de esta oficina.']},
        ...
        {h2: 'Canal de ética', p: ['Las inquietudes sobre nuestra conducta pueden reportarse a la oficina por correo o teléfono. Los reportes los atiende la dirección general y, cuando hace falta, asesoría legal externa.']},
      ],
    },
  },
  certifications: {
    en: {
      ...
      lead: 'Every credential below is shown with its issuer and scope. Ask the duty officer for a copy of any certificate.',
      blocks: [
        {h2: 'Licences and registrations', ul: ['Ship agency licence, Panama Maritime Authority (AMP).', 'Shipping agency authorization, Panama Canal Authority.', 'IMO company number 5785507.', 'RUC 1675308-1-680680 DV 34, Cross World Agencies, S.A.']},
        {h2: 'ISO 9001:2015, quality management', p: ['Certified by AQC Middle East LLC, a certification body accredited by IAS (IAF member). Scope: management, chartering, administration and operation of ships: general cargo ships, tankers, bulk carriers, tug vessels and barges.']},
        {h2: 'ISO 14001:2015, environmental management', p: ['Certified by AQC Middle East LLC (accredited by IAS).']},
        {h2: 'ISO 45001:2018, occupational health and safety', p: ['Certified by AQC Middle East LLC (accredited by IAS).']},
        {h2: 'ISO 22000:2018, food safety management', p: ['Certified by AQC Middle East LLC (accredited by IAS). Scope: food cargo inspections of agricultural origin, bulk food cargo certifier.']},
    ...
    es: {
      ...
      lead: 'Cada credencial se muestra con su emisor y su alcance. Pida al oficial de guardia copia de cualquier certificado.',
      blocks: [
        {h2: 'Licencias y registros', ul: ['Licencia de agencia naviera, Autoridad Marítima de Panamá (AMP).', 'Autorización como agencia naviera, Autoridad del Canal de Panamá.', 'IMO company number 5785507.', 'RUC 1675308-1-680680 DV 34, Cross World Agencies, S.A.']},
        {h2: 'ISO 9001:2015, gestión de calidad', p: ['Certificada por AQC Middle East LLC, organismo de certificación acreditado por IAS (miembro del IAF). Alcance: gestión, fletamento, administración y operación de buques: carga general, tanqueros, graneleros, remolcadores y barcazas.']},
        {h2: 'ISO 14001:2015, gestión ambiental', p: ['Certificada por AQC Middle East LLC (acreditado por IAS).']},
        {h2: 'ISO 45001:2018, seguridad y salud en el trabajo', p: ['Certificada por AQC Middle East LLC (acreditado por IAS).']},
        {h2: 'ISO 22000:2018, inocuidad alimentaria', p: ['Certificada por AQC Middle East LLC (acreditado por IAS). Alcance: inspecciones de carga alimentaria de origen agrícola, certificador de carga alimentaria a granel.']},
  ...
  compliance: {
    en: {
      ...
      blocks: [
        ...
        {h2: 'KYC pack (supplier onboarding)', ul: ['Public Registry certificate of Cross World Agencies, S.A.', 'AMP ship agency licence.', 'Panama Canal Authority authorization.', 'ISO 9001, 14001, 45001 and 22000 certificates with scope.', 'W-8BEN-E.', 'Bank reference letter.']},
        ...
        {h2: 'Ethics channel', p: ['Report concerns about our conduct to the office by email or phone; the captain handles them personally.']},
      ],
    },
    es: {
      ...
      blocks: [
        ...
        {h2: 'KYC pack (alta de proveedor)', ul: ['Certificado del Registro Público de Cross World Agencies, S.A.', 'Licencia de agencia naviera de la AMP.', 'Autorización de la Autoridad del Canal de Panamá.', 'Certificados ISO 9001, 14001, 45001 y 22000 con alcance.', 'W-8BEN-E.', 'Carta de referencia bancaria.']},
        ...
        {h2: 'Canal de ética', p: ['Reporte inquietudes sobre nuestra conducta a la oficina por correo o teléfono; el capitán las atiende personalmente.']},
      ],
    },
  },
  contact: {
  ...
  privacy: {
    en: {
      ...
      lead: 'Cross World Agencies, S.A. (RBS Tower, 9th floor, office 902, Paitilla, Panama City) is the controller of the personal data processed through this website. Last updated 31 August 2026. Draft for legal review.',
      blocks: [
    ...
    es: {
      ...
      lead: 'Cross World Agencies, S.A. (RBS Tower, piso 9, oficina 902, Paitilla, Ciudad de Panamá) es responsable de los datos personales tratados a través de este sitio. Última actualización: 31 de agosto de 2026. Borrador para revisión legal.',
      blocks: [
  ...
  terms: {
    en: {
      ...
      lead: 'These conditions apply to every service Cross World Agencies, S.A. provides and are referenced in every PDA, FDA and email. Draft based on the FONASBA / ITIC model for legal review under Panamanian law.',
      blocks: [
    ...
    es: {
      ...
      lead: 'Estas condiciones aplican a todo servicio que presta Cross World Agencies, S.A. y se referencian en cada PDA, FDA y correo. Borrador basado en el modelo FONASBA / ITIC para revisión legal bajo ley panameña.',
      blocks: [
