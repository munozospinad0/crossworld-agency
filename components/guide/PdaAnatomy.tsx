...
const T = {
  ...
  es: {
    ...
    lines: [
      ...
      {id: 'husbandry', label: 'Avituallamiento (si lo solicita)', basis: 'Costo real con comprobante', who: 'third', known: 'En la FDA', note: 'Cambios de tripulación, transporte, provisiones, repuestos, atención médica, cash to master. Solo lo que pida, cada línea con su comprobante.'},
